...
List<OnboardingStep> buildOnboardingSteps(AppLocalizations l10n) => [
  ...
  OnboardingStep(
    ...
    options: [
      OnboardingOption(id: 'global', label: l10n.stepAccountTypeOptGlobal, subtitle: l10n.stepAccountTypeOptGlobalSub, assetPath: 'assets/account_global.png'),
      OnboardingOption(id: 'national', label: l10n.stepAccountTypeOptNational, subtitle: l10n.stepAccountTypeOptNationalSub, assetPath: 'assets/account_national.png'),
    ],
  ),
  OnboardingStep(
    id: 'pep',
